                    ...
                    <div class="row product-grid">
                        @foreach($products as $p)
                            ...
                            <div class="col-lg-1-5 col-md-4 col-6 col-sm-6" style="margin-bottom: 15px;">
                                <div class="product-cart-wrap mb-30 product-card-{{ $p->id }} {{ $firstVariantStock <= 0 ? 'product-out-of-stock' : '' }}">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{ route('product.details', $p->id) }}" class="product-card-link">
                                                @php
                                        ...
                                        <div class="product-action-1" style="{{ $firstVariantStock <= 0 ? 'display: none !important;' : '' }}">
                                            <a aria-label="Add To Wishlist"
                                                class="action-btn add-to-wishlist {{ (auth('customer')->check() && auth('customer')->user()->wishlist()->where('product_id', $p->id)->exists()) || (!auth('customer')->check() && in_array($p->id, session()->get('guest_wishlist', []))) ? 'active' : '' }}"
                                                data-id="{{ $p->id }}" href="javascript:void(0)">
                                                <i class="fi-rs-heart"></i>
                                            </a>
                                            <a aria-label="Quick view" class="action-btn quick-view-btn"
                                                href="javascript:void(0)" data-product-id="{{ $p->id }}">
                                                <i class="fi-rs-eye"></i>
                                            </a>
                                        </div>
                                        ...
                                        <div class="product-card-bottom" style="flex-direction: column; align-items: stretch;">
                                            ...
                                            @if($p->variants->count() > 0)
                                                ...
                                                <div class="product-variant-selector" style="text-align: center; margin-bottom: 8px;">
                                                    <select class="form-control product_Dropdown variant-dropdown-{{ $p->id }}"
                                            ...
                                            <div class="product-price" style="text-align: center; margin-bottom: 10px;">
                                                <div class="product-price-display-{{ $p->id }}"
                                                    style="font-size: 15px; font-weight: 600;">
                                                    @if($originalPrice && $originalPrice > $currentPrice)
                                                        <span class="product-mrp-display-{{ $p->id }}"
                                                    ...
                                                    @endif
                                                    <span class="product-sell-price-{{ $p->id }}"
                                            ...
                                            <div
                                                ...
                                                <div style="display: flex; align-items: center;" class="col-6 pe-1">
                                                    ...
                                                    <input type="number" class="qty-input product-qty-{{ $p->id }}" value="1" min="1" {{ $firstVariantStock <= 0 ? 'disabled' : '' }}>
                                                </div>

                                                {{-- Add to Cart Button --}}
                                                <div class="add-cart col-6 ps-1" style="{{ $firstVariantStock <= 0 ? 'display: none !important;' : '' }}">
                                                    <a href="javascript:void(0)" class="add col-12 add-to-cart-btn-{{ $p->id }}"
                                                        data-product-id="{{ $p->id }}" data-price="{{ $currentPrice }}"
                    ...
                    <div class="pagination-area mt-20 mb-20">
                        ...
                        <ul class="pagination justify-content-start">
                            ...
                            <li class="page-item {{ $currentPage == 1 ? 'disabled' : '' }}">
                                <a class="page-link d-flex align-items-center justify-content-center" href="{{ $products->url($currentPage - 1) }}"><i
                                        class="fi-rs-angle-left"></i></a>
                            </li>

                            @for ($i = 1; $i <= $totalPages; $i++)
                                <li class="page-item {{ $i == $currentPage ? 'active' : '' }}">
                                    <a class="page-link d-flex align-items-center justify-content-center" href="{{ $products->url($i) }}">{{ $i }}</a>
                                </li>
                            @endfor
