            ...
            <div class="row mb-5">
                ...
                <div class="col-lg-10 col-md-12 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
                    <div class="scroll-wrapper position-relative">
                        <div class="scroll-container" id="scroll-container-<?php echo e($offer->id); ?>">
                            <?php $__empty_2 = true; $__currentLoopData = $offerProducts[$offer->id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                <?php
                                    $firstVariantStock = $product->variants->first() ? ($product->variants->first()->stock ?? 0) : ($product->stock ?? 0);
                                ?>
                                <div class="product-cart-wrap offer-product-card-<?php echo e($product->id); ?> <?php echo e($firstVariantStock <= 0 ? 'product-out-of-stock' : ''); ?>">
                                    <div class="product-img-action-wrap">
                                            ...
                                            <div class="product-action-1" style="<?php echo e($firstVariantStock <= 0 ? 'display: none !important;' : ''); ?>">
                                                <a aria-label="Add To Wishlist"
                                                    ...
                                                    data-id="<?php echo e($product->id); ?>" href="javascript:void(0)"><i
                                            ...
                                            <div class="product-badges product-badges-position product-badges-mrg">
                                                ...
                                                <?php else: ?>
                                                     <?php if($offer->discount_type === 'percentage'): ?>
                                                        <span class="hot">Save <?php echo e((float)$offer->discount_value); ?>%</span>
                                                    <?php else: ?>
                                                        <span class="hot">Save ₹<?php echo e((float)$offer->discount_value); ?></span>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                    ...
                                    <div class="product-content-wrap">
                                        <h2 style="text-align: center;"><a
                                                href="<?php echo e(route('product.details', $product->id)); ?>" class="product-card-link"><?php echo e($product->productname); ?></a>
                                        </h2>
                                        ...
                                        <div class="product-card-bottom" style="flex-direction: column; align-items: stretch;">
                                            ...
                                            <?php if($product->variants->count() > 0): ?>
                                                ...
                                                <div class="product-variant-selector" style="text-align: center;">
                                                    <select class="form-control form-control-sm product_Dropdown offer-variant-dropdown-<?php echo e($product->id); ?>"
                                                        data-product-id="<?php echo e($product->id); ?>" <?php echo e($firstVariantStock <= 0 ? 'disabled' : ''); ?>>
                                                        <?php $__currentLoopData = $product->variants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vIndex => $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <option value="<?php echo e($variant->id); ?>"
                                                                ...
                                                                data-offer-price="<?php echo e($variantOfferPrice); ?>"
                                                                data-mrp-price="<?php echo e($variantSellPrice); ?>"
...
</script><?php /**PATH /home/kidsmittaisbhask/public_html/chennaiangadi/frontend/resources/views/section/offered-products.blade.php ENDPATH**/ ?>