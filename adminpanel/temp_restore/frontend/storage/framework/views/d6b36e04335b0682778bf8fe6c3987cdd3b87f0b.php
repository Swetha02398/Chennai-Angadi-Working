            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        // updateTotalsDisplay(); // This will be called again in calculateShipping success handler
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kidsmittaisbhask/public_html/chennaiangadi/frontend/resources/views/checkout/checkout-order.blade.php ENDPATH**/ ?>