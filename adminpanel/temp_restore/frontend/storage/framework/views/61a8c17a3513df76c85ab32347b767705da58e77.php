               ...
               <div class="row">
                <div class="col-xl-6">
                    <div class="contact-from-area padding-20-row-col">
                        ...
                        <form class="contact-form-style mt-2" id="contact-form" action="<?php echo e(route('pages.contact.store')); ?>" method="post" novalidate>
                            <?php echo csrf_field(); ?>
                            <div class="row m-0 p-0">
                                <div class="col-lg-6 col-xs-12 p-0 mb-3">
                                    <input name="name" id="name" class="form-control mb-1" placeholder="Name" type="text" value="<?php echo e(old('name')); ?>" required />
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-lg-6 col-xs-12 p-0 mb-3">
                                    <input name="email" id="email" class="form-control mb-1" placeholder="Your Email" type="email" value="<?php echo e(old('email')); ?>" required />   
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-lg-12 col-xs-12 p-0 mb-3">
                                    <input name="telephone" id="telephone" class="form-control mb-1" placeholder="Mobile Number" type="text" value="<?php echo e(old('telephone')); ?>" required minlength="10" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'')" />
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row m-0 p-0">
                                <div class="col-12 p-0 mb-3">
                                    <textarea style="height:150px;" name="message" id="message" class="form-control mb-1" placeholder="Message" required><?php echo e(old('message')); ?></textarea>                                    
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <button class="submit submit-auto-width col-xs-12 mb-2" type="submit"><img src="<?php echo e(asset('assets/imgs/theme/icons/icon-email-2.svg')); ?> "
                ...
                <div class="col-lg-6 d-lg-block d-none">
                    ...
                    <p class="d-flex align-items-center"><img src="<?php echo e(asset('assets/imgs/theme/icons/icon-location.svg')); ?> "
                                    alt="" style="height:25px; padding-right:15px;" /> New # 15/Old # 8,
                    Muthu Street, Mylapore,<br />
                    Chennai - 600004<br />
                    </p>
                    <p class="d-flex align-items-center"><img src="<?php echo e(asset('assets/imgs/theme/icons/icon-contact.svg')); ?> "
                                    alt="" style="height:25px; padding-right:15px;"/> +91 90946 76665</p>
                    <p class="d-flex align-items-center"><img src="<?php echo e(asset('assets/imgs/theme/icons/icon-email-2.svg')); ?> "
                    ...
                    <!-- <img class="border-radius-15 mt-50" src="<?php echo e(asset('assets/imgs/images/contact-img.jpg')); ?>" alt="contact image" /> -->
                     <div class="row m-0 p-0">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kidsmittaisbhask/public_html/chennaiangadi/frontend/resources/views/pages/contact.blade.php ENDPATH**/ ?>