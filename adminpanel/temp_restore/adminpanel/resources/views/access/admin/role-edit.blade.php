...
<section class="content-main">
    <div class="content-header">
        <div>
            <h2 class="content-title card-title">Edit Role: {{ $role->name }}</h2>
        </div>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            <form id="roleForm" action="{{ route('admin.roles.update', $role->id) }}" method="POST" novalidate>
                @csrf
                @method('PUT')
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" id="roleName" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $role->name) }}" required>
                ...
                <div class="mb-3 d-flex flex-wrap gap-2">
                    ...
                    <button type="button" class="btn btn-sm btn-info text-black column-toggle-btn" data-column="view">
                    ...
                    <button type="button" class="btn btn-sm btn-info text-black column-toggle-btn" data-column="delete">
