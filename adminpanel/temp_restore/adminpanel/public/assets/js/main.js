!(function (e) {
  ...
  // Global form validation interaction
  e(document).on("input", ".form-control, .form-select", function () {
    if (e(this).val().trim() !== "") {
      e(this).removeClass("is-invalid").addClass("is-valid");
      e(this).siblings(".text-danger").addClass("d-none");
      e(this).parent().find(".text-danger").addClass("d-none");
    } else {
      e(this).removeClass("is-valid");
    }
  });
