...
<i class="bi bi-x-circle me-1"></i> Inactive</span>
                                    ...
                                    <td>
                                        @if(auth()->user()->isSuperAdmin() || auth()->user()->hasPermission('offers-edit'))
                                        <a href="{{ route('offer.edit', $offer->id) }}" class="btn btn-sm btn-warning btn-action-col d-inline-flex align-items-center justify-content-center"><i
                                        ...
                                        <form action="{{ route('offer.delete', $offer->id) }}" method="POST" class="d-inline">
                                            ...
                                            <button type="submit" class="btn btn-sm btn-danger btn-action-col d-inline-flex align-items-center justify-content-center "
                                                onclick="return confirm('Delete this offer?')"><i class="bi bi-trash me-1"></i> Delete</button>
                                        </form>
                                        @endif
                                    </td>
                                </tr>
