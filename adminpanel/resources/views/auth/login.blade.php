...
<div class="auth-container">
    <div class="glass-card">
        ...
        <p class="login-subtitle">ENTER YOUR CREDENTIALS TO ACCESS DASHBOARD</p>
        ...
        <form method="POST" action="{{ route('login.submit') }}" class="needs-validation" novalidate>
            ...
            <div class="input-group-custom">
                <input name="username" type="text" placeholder="Username, email or phone" required value="{{ old('username') }}" autocomplete="username">
                <div class="invalid-feedback">Please enter your username, email or phone.</div>
                @error('username')
