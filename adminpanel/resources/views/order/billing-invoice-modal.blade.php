{{-- Unified Billing Invoice content for Modal Popup --}}
<style>
    ...
    .invoice-print-content .order-info-box .order-date { font-size: 10px; color: #666; margin-top: 2px; }
    ...
    .invoice-print-content .items-table td:nth-child(2) { text-align: left; white-space: normal; }
    .invoice-print-content .items-table td.subtotal-col { font-weight: bold; }
    .invoice-print-content .items-table .product-name { color: #000; text-align: left; font-weight: normal; white-space: normal; }
