                                    ...
                                    <div class="product-cart-wrap d-flex flex-column h-100">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="{{ route('product.details', $product->id) }}">
                                                    <img class="default-img" src="{{ $imageUrl }}" alt="{{ $product->productname }}"
                                                        onerror="this.src='{{ asset('assets/imgs/images/default-product.png') }}'" />
                                                    <img class="hover-img" src="{{ $imageUrl }}" alt="{{ $product->productname }}"
                                                        onerror="this.src='{{ asset('assets/imgs/images/default-product.png') }}'" />
                                                </a>
                                            </div>
                                        ...
                                        <div class="product-content-wrap">
                                            <h2 style="text-align: center;">
                                                <a
                                                    href="{{ route('product.details', $product->id) }}">{{ Str::limit($product->productname, 40) }}</a>
                                            </h2>
                                            ...
                                            <div class="product-card-bottom" style="flex-direction: column; align-items: stretch;">
                                                ...
                                                @if($product->variants->count() > 0)
                                                    ...
                                                    <div class="product-variant-selector" style="text-align: center; margin-bottom: 8px;">
                                                        <select class="form-control form-control-sm sr-variant-dropdown-{{ $product->id }}"
                                                ...
                                                <div class="product-price" style="text-align: center; margin-bottom: 10px;">
                                                    <div class="sr-product-price-display-{{ $product->id }}" style="font-size: 15px; font-weight: 600;">
                                                        @if($originalPrice && $originalPrice > $currentPrice)
                                                            <span class="sr-product-mrp-display-{{ $product->id }}"
                                                        ...
                                                        @endif
                                                        <span class="sr-product-sell-price-{{ $product->id }}"
                                                ...
                                                <div style="display: flex; justify-content: space-between; align-items: flex-end; gap: 10px; margin-top: auto;">
                                                    <div style="display: flex; align-items: center; gap: 5px;">
                                                        ...
                                                        <input type="number" class="sr-product-qty-{{ $product->id }}" value="1" min="1" style="width: 40px; height: 28px; font-size: 12px; text-align: center; border: 1px solid #BCE3C9; border-radius: 4px; padding: 0; outline: none;">
                                                    </div>
                                                    ...
                                                    @endphp
                                                    <div class="add-cart">
                                                        <a href="javascript:void(0)" class="add sr-add-to-cart-btn-{{ $product->id }}"
                                                            data-product-id="{{ $product->id }}" data-price="{{ $currentPrice }}"
                                                            data-stock="{{ $firstVariantStock }}"
                                                            style="display: inline-flex; align-items: center; white-space: nowrap; padding: 7px 18px; font-size: 13px; font-weight: 600; {{ $firstVariantStock <= 0 ? 'opacity: 0.5; cursor: not-allowed; pointer-events: none; color: #fff; background-color: #dc3545; border-color: #dc3545;' : '' }}">
                                                            <i class="fi-rs-shopping-cart mr-5"></i>{{ $firstVariantStock <= 0 ? 'OUT OF STOCK' : 'ADD' }}
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
