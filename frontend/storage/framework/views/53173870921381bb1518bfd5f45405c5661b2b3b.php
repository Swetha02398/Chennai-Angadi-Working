                                ...
                                <div class="tab-content account dashboard-content">
                                    <div class="tab-pane fade active show" id="dashboard" role="tabpanel"
                                        ...
                                        <p>From your account dashboard. you can easily check &amp; view your <a
                                                        href="<?php echo e(url('myAccount')); ?>?tab=orders">recent orders</a>,<br />
                                                    manage your <a href="<?php echo e(url('myAccount')); ?>?tab=account-detail">shipping and billing addresses</a> and <a
                                                        href="<?php echo e(url('myAccount')); ?>?tab=account-detail&edit=1">edit your password and account details.</a>
                                                </p>                                        
                                    </div>
                                                                ...
                                                                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            ?>
                                                                            <span class="badge order-status-badge <?php echo e($statusBg); ?>">
                                                                                <i class="<?php echo e($statusIcon); ?> me-1"></i> <?php echo e($statusLabel); ?>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            ?>
                                                                            <span class="badge order-status-badge <?php echo e($payBg); ?>">
                                                                                <i class="<?php echo e($payIcon); ?> me-1"></i> <?php echo e($payLabel); ?>
                                                                        ...
                                                                        <td>
                                                                            <button class="btn me-1 order-action-btn"
                                                                                onclick="viewOrder(<?php echo e($order->id); ?>)">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 mb-3">
                                                                    <select class="form-control" name="gender">
                                                                        <option value="" disabled <?php echo e(empty($customer->gender) ? 'selected' : ''); ?>>Gender</option>
                                                                ...
                                                                <div class="col-md-6 mb-3">
                                                                     <input type="text" onfocus="(this.type='date')" onblur="(this.type='text')" class="form-control" name="dob" value="<?php echo e($customer->dob); ?>" placeholder="Date of Birth">
                                                                </div>
                                                            </div>
                    ...
                    if (data.success) {
                        ...
                        contentDiv.innerHTML = `
                            <div class="invoice-print-content" style="font-family: inherit; background: #fff; color: #000; padding: 5px;">
                                ...
                                <div class="gi-header">
                                    <div class="gi-logo">
                                        <img src="<?php echo e(asset('assets/imgs/images/ChennaiAngadiLogo.png')); ?>" alt="Chennai Angadi" style="height: 50px; width: auto;">
                                    </div>
                                    <div class="gi-title">
