            ...
            <div class="row">
                <div class="col-lg-8">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="pt-30">
                                        ...
                                        <td class="image product-thumbnail pt-40">
                                            ...
                                            ?>
                                            <img src="<?php echo e(env('ADMIN_ASSET_URL')); ?>/products/<?php echo e($primaryImage); ?>" width="100"
                                                height="100" alt="<?php echo e($item->product->productname); ?>"
                                        ...
                                        <td class="product-des product-name">
                                            ...
                                            <?php if($weightName): ?>
                                                <span style="color: #3BB77E; font-size: 13px; font-weight: 500;"
                                                    class="d-block mb-5"><?php echo e($weightName); ?></span>
                                            <?php endif; ?>
                                            ...
                                            <!-- <?php
                                                                                            ...
                                                                                            <div class="product-rate-cover">
                                                                                                <div class="product-rate d-inline-block">
                                                                                                    <div class="product-rating" style="width: <?php echo e($avgRatingPercent); ?>%"></div>
                                                                                                </div>
                                                                                                <span class="font-small ml-5 text-muted">(<?php echo e($avgRating ?: '0.0'); ?>)</span>
                                                                                            </div> -->
                                        </td>


                                        <td class="price" data-title="Price">
                                            <h4 class="text-body">₹<?php echo e($item->price_at_add_time); ?></h4>
                                        </td>
                                            ...
                                            <div class="detail-extralink mr-15">
                                                <div class="detail-qty border radius">
                                                    ...
                                                    <input type="text" name="quantity" class="qty-val"
                                                        value="<?php echo e($item->quantity); ?>" min="1" data-item-id="<?php echo e($item->id); ?>"
                                                        onchange="updateCartQuantity(this, '<?php echo e($item->id); ?>')">
                                        ...
                                        <td class="price" data-title="Subtotal">
                                            <h4 class="text-brand subtotal-<?php echo e($item->id); ?>">
                                                ₹<?php echo e($item->price_at_add_time * $item->quantity); ?></h4>
                                        </td>
                                        <td class="action text-center" data-title="Remove">
                                            <a href="#" class="text-body"
                                                onclick="removeFromCart('<?php echo e($item->id); ?>'); return false;">
                            ...
                            <div class="cart-card mb-3 p-2">
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div class="product-info-mobile flex-grow-1">
                                        <h6 class="product-name mb-0" style="font-size: 16px; color: #253D4E;"><?php echo e($item->product->productname); ?></h6>
                                        <?php if($weightName): ?>
                                            <span class="text-muted font-sm"><?php echo e($weightName); ?></span>
                                        <?php endif; ?>
                                    </div>
                                    <div class="product-remove-mobile">
                                        <a href="#" class="text-muted" onclick="removeFromCart('<?php echo e($item->id); ?>'); return false;">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <div class="product-price-mobile">
                                        <h4 class="text-body mb-0 subtotal-<?php echo e($item->id); ?>" style="font-weight: 700;">₹<?php echo e($item->price_at_add_time * $item->quantity); ?></h4>
                                    </div>
                                    <div class="detail-qty mobile-qty-compact border radius d-flex align-items-center">
                                        <input type="text" name="quantity" class="qty-val" value="<?php echo e($item->quantity); ?>" readonly 
                    ...
                    <div class="cart-action d-flex justify-content-between mb-4">
                        ...
                        <a href="<?php echo e(route('index')); ?>" class="btn d-none d-md-inline-flex align-items-center">
                            <i class="fi-rs-arrow-left mr-10"></i>Continue Shopping
                        </a>
                        
                        <a href="<?php echo e(route('index')); ?>" class="btn w-100 d-md-none">
                            <i class="fi-rs-arrow-left mr-10"></i>Continue Shopping
                        </a>
                    </div>
                    <!-- <div class="row mt-50">
                ...
                <div class="col-lg-4">
                    <div class="border p-md-4 cart-totals ml-30">
                                ...
                                <tbody>
                                    <!-- <tr>
                                                                    ...
                                                                    <td class="cart_total_amount">
                                                                        <h4 class="text-brand text-end" id="cart-subtotal">₹<?php echo e(number_format($subtotal, 2)); ?></h4>
                                                                    </td>
                                                                </tr> -->
                                    <!-- <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="cart_total_amount">
                                            <h4 class="text-brand text-end" id="cart-total">₹<?php echo e(number_format($total, 0)); ?>
                        ...
                        <a href="<?php echo e(route('checkout-order')); ?>" class="btn mb-20 w-100">Proceed To CheckOut<i
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        const cartSubtotal = <?php echo e($subtotal); ?>;
        ...
        function storeCouponInSession(code, discount) {
            $.ajax({
                url: "<?php echo e(route('cart.store-coupon')); ?>",
                type: 'POST',
                data: {
                    _token: csrfToken,
                    coupon_code: code,
        ...
        function clearCouponFromSession() {
            $.ajax({
                url: "<?php echo e(route('cart.clear-coupon')); ?>",
                type: 'POST',
                data: {
                    _token: csrfToken
                },
        ...
        <?php if(session('cart_coupon_code')): ?>
            $(document).ready(function () {
                cartCouponDiscount = <?php echo e(session('cart_coupon_discount', 0)); ?>;
                appliedCouponCode = '<?php echo e(session('cart_coupon_code')); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\chennais\frontend\resources\views/section/add-cart-blade.blade.php ENDPATH**/ ?>