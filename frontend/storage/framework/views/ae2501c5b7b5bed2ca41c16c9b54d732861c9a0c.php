...
<?php $__env->startSection('content'); ?>
                                        ...
                                        <form class="contact-form-style my-3" id="track_order_form"
                                            ...
                                            <div class="input-style mb-20">
                                                ...
                                                <input name="order_number" id="track_order_number"
                                                    ...
                                                    class="form-control" />
                                                <div id="order_number_error" class="text-danger mt-1" style="display:none; font-size:14px; font-weight:500;">Please enter your Order ID to track.</div>
                                            </div>
    ...
    <script>
        ...
        function trackOrder(event) {
            ...
            const orderInput = document.getElementById('track_order_number');
            const orderNumber = orderInput.value.trim();
            const errorDiv = document.getElementById('order_number_error');

            if (!orderNumber) {
                orderInput.style.borderColor = '#dc3545';
                errorDiv.style.display = 'block';
                document.getElementById('track_order_message').innerHTML = '';
                return false;
            } else {
